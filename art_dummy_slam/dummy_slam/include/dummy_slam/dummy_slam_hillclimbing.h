...
#include "dummy_slam_transformation.h"
namespace crsm_slam{
	/**
	...
	struct CrsmHillClimbingPerson{
		...
		CrsmTransformation t;	//!< The individual's genome. Holds the robot possible transformation
		float fitness;			//!< The individual's fitness value.
	};
