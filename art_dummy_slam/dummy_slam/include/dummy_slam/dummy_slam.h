...
#include "dummy_slam_laser.h"
#include "dummy_slam_hillclimbing.h"
#include "dummy_slam_pose.h"
#include "dummy_slam_map.h"
#include "dummy_slam_slamParameters.h"
  ...
  class CrsmSlam{
    ...
    public:
      ...
      /**
        ...
        @return void
       **/
      void publishOGM(const ros::TimerEvent& event);
